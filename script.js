...
const fastShellBlacklist = ['Strobe', 'Floral', 'Crysanthemum'];
...
function init() {
	...
	// shell size
	options = '';
	['那个是软的', '有点感觉了', '逐渐变硬', '半硬半软', '硬起来啦', '啊你的那个太舒服啦'].forEach((opt, i) => options += `<option value="${i}">${opt}</option>`);
